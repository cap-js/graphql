...
module.exports = cache => {
  ...
  const _entityToObjectType = entity => {
    ...
    const createInputObjectType = inputObjectGenerator(cache, false).entityToInputObjectType(entity)
    const updateInputObjectType = inputObjectGenerator(cache, true).entityToInputObjectType(entity)
