...
module.exports = cache => {
  const entityToObjectConnectionType = entity => {
    ...
    const fields = {}
    // TODO: what should descriptions of connections look like?
    const newEntityObjectConnectionType = new GraphQLObjectType({ name, description: entity.doc, fields: () => fields })
    cache.set(name, newEntityObjectConnectionType)

    fields[CONNECTION_FIELDS.nodes] = { type: new GraphQLList(entityToObjectType(entity)), description: entity.doc }
