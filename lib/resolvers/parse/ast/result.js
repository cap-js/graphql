...
const formatResult = (entity, field, result, is2many, isConnection) => {
  const _formatObject = (type, selections, object) => {
    ...
    for (const key in object) {
      ...
      for (const field of fields) {
        ...
        result[responseKey] = _formatByType(elementType, field, _coerceToObjectOrArray(value, is2many), is2many)
      }
    }
  ...
  return _formatByType(entity, field, _coerceToObjectOrArray(result, is2many), isConnection)
}
