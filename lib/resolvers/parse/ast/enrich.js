...
module.exports = info => {
  ...
  const editedAST = visit(deepClonedFieldNodes, {
    [Kind.SELECTION_SET](node) {
      ...
      // Note: FragmentSpread visitor cannot be used to replace fragment spreads with fragment definitions that
      // contain multiple top level selections, since those must be placed directly into the selection set
    ...
    // Literals are not parsed within the AST
